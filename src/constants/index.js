export const myProjects = [
  {
    ...
    href: "https://github.com/ReetBashak/moviesite",
    tags: [
      {
        id: 1,
        name: "React",
  ...
  },
  {
    ...
    href: "https://github.com/ReetBashak/sitenews",
    tags: [
      {
        id: 1,
        name: "React",
  ...
  },
  {
    ...
    title: "GatherGo",
    description:
      "A feature-rich full-stack application for streamlined discovery and booking, featuring a secure multi-user architecture and administrative control.",
    subDescription: [
      "Implemented secure user authentication and account verification using JWT and OTP protocols.",
      "Built a robust backend using Node.js, Express, and MongoDB for scalable data management.",
      "Developed an integrated admin panel for efficient management of listings and booking orders.",
    ],
    href: "https://eventora-flax.vercel.app/",
    tags: [
      {
        id: 1,
        name: "MongoDB",
